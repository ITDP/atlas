  ...
  if(is.null(rank$admin_level)) {
    ...
    indicator_label <- switch(indicator$mode,
                              ...
                              "pncf" = sprintf("In %s, %s%s of people in urban areas in %s lived within 100m of a car-free space.", 
                                               ...
                                               style_number("%"), 
                                               style_text("the world")),
                              "pnnhighways" = sprintf("In %s, %s%s of people in urban areas in %s lived farther than 500m from a grade-separated highway. ", 
                                              input$year,
                                              style_number(format_indicator_world_mean), 
                                              style_number("%"), 
                                              style_text("the world")),
                              ...
                              "pnft" = sprintf("In %s, %s%s of people in urban areas in  %s lived within 500m of a transport stop where a bus or train comes every 10 minutes or sooner.", 
                                               ...
                                               style_number("%"), 
                                               style_text("the world")),
                              "pnst" = sprintf("In %s, %s%% of people in urban areas in %s lived within walkable distance of both protected cycleways and frequent/rapid public transport.", 
                                               input$year,   
                                               style_number(format_indicator_world_mean), 
                                               style_text("the world"))
                   ...
                   if(run & run2) {
                     ...
                     indicator_label <- switch(indicator$mode,
                                               ...
                                               "pncf" = sprintf("In %s, %s%s of people in %s lived within 100m of a car-free space.", 
                                                                ...
                                                                style_number("%"), 
                                                                style_text(rank_indicator$name)),
                                               "pnnhighways" = sprintf("In %s, %s%s of people in %s lived farther than 500m from a grade-separated highway. ", 
                                                               input$year,
                                                               style_number(format_indicator_value), 
                                                               style_number("%"), 
                                                               style_text(rank_indicator$name)),
  ...
  if (isTRUE(rank$admin_level == 1)) {
    ...
    indicator_label <- switch(indicator$mode,
                              ...
                              "pnnhighways" = sprintf("In %s, %s%s of people in %s lived farther than 500m from a grade-separated highway. ", 
                                              ...
                                              style_number("%"), 
                                              style_text(rank_indicator$name)),
                              "pnpb" = sprintf('In %s, %s%s of people in %s lived within a 300m walk of a protected bikeway. ', 
                                               input$year,
                                               style_number(format_indicator_value), 
                                               style_number("%"), 
                                               style_text(rank_indicator$name)),
