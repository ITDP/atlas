...
'<p>People Near Car-Free Places measures the percentage of an area’s population living immediately nearby (within 100m of) a car-free place. This includes parks, squares, car-free streets, alleyways, or pathways. </p>',
...
'<p>Car-free public places can be both an amenity and a piece of pedestrian transportation infrastructure because they provide safe walking routes to destinations which are often calmer and more direct.  </p>'
)
...
'<p>We use data from OpenStreetMap, identifying all places marked as pathways, parks, plazas, or otherwise car-free areas. We then count the number of people living within a simple 100m buffer of these places.</p>',
'<p>Because OpenStreetMap data quality varies so dramatically, and correlates with income, it may appear that higher-income cities have a much higher score than low-income ones, even if the actual infrastructure on the ground is comparable</p>',
'</div>')       
...
'<li><strong>Integrate spaces <a target="_blank" href="https://90ffb89e-d990-4f1a-90f3-7974ef8ea8c5.filesusr.com/ugd/534edb_67a4d41d9f9e4e5f80ef259bd60fd7d8.pdf">designed for play</a> into neighborhoods.</strong>',
