...
'<ul>',
'<li><strong>Make space for people</strong> to relax and play by creating <a target="_blank" href="https://www.wri.org/insights/safe-city-just-city">pocket parks</a> on vacant lots and converting street parking to ‘<a target="_blank" href="https://www.itdp.org/2014/05/09/reclaiming-the-city-one-space-at-a-time/">parklets</a>.” ',
