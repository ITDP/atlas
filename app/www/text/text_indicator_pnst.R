...
sprintf('<p>In %s at the end of %s, %s%% of people live within 300m of protected bicycle infrastructure and also within either 500m of frequent public transport or 1km of mass rapid transport. %s</p>', 
