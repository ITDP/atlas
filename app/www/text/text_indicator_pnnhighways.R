...
'<p>Although a shift to electric cars will lessen some of these problems and EVs are an important tool in combating climate change, highways will still contribute to noise and <a href="https://www.emissionsanalytics.com/news/pollution-tyre-wear-worse-exhaust-emissions">air pollution</a> –– and high-speed traffic is no less dangerous to humans.</p>'
)
