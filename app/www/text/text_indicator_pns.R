...
sprintf('<p>In %s at the end of %s, we identified %s healthcare services and %s education services. We found that %s %% of people live within a 1km walk of healthcare; %s %% of people live within a 1km walk of education, and %s %% of people live within a 1km walk of both. %s</p>', 
