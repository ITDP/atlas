...
sprintf('<p>In %s at the end of %s, there were %s transit stops where a bus, train, or other vehicle stops at least every 10 minutes throughout the day. %s%% of people live within 500m of one. %s</p>', 
