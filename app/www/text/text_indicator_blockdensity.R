...
'<p><a href="https://staging.unhabitat.org/downloads/docs/StreetPatterns.pdf">Small blocks</a> make a neighborhood walkable by letting people take the most direct route to their destination, combine trips more easily, or choose the most pleasant route. On smaller blocks, cars move more slowly, increasing pedestrian safety. </p>',
...
'<li><strong><a href="https://ovacen.com/wp-content/uploads/2015/04/espacios-urbanos-y-paisajes.pdf">Plan for urban expansion</a></strong> by laying out a network of streets and walkways with small blocks ahead of time, allowing for the densification necessary for walkability. ',
