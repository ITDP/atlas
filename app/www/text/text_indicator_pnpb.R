...
sprintf('<p>In %s, at the end of %s, %s%% of residents live within a 300m walk of a physically protected bikeway. More generally, %s%% of residents lived within a 300m walk of any bikeway, protected or unprotected. In %s, in %s, there were %s kilometers of bikeways, of which %s were physically protected. %s</p>', 
