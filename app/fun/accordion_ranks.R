accordion_ranks <- function(id_accordion, id1, id2) {
  ...
  div(class = "accordion collapsed in",  id="accordionExample",
      div(class = "accordion_item",
          tags$button(class="accordion-button collapsed", style = "padding: 0", type="button", 'data-toggle'="collapse", 'data-target'=paste0("#", id_accordion), 'aria-expanded'="false", 'aria-controls'="collapseOne",
